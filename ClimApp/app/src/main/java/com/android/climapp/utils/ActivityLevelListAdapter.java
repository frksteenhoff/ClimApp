...
public class ActivityLevelListAdapter extends ArrayAdapter<com.android.climapp.utils.ActivityLevelList> {

    public ActivityLevelListAdapter(Activity context, ArrayList<com.android.climapp.utils.ActivityLevelList> texts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.android.climapp.utils.ActivityLevelList currentActivity = getItem(position);
